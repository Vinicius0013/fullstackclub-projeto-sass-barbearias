...
const ServiceItem = ({ service, barbershop }: ServiceItemProps) => {
  ...
  const [selectedTime, setSelectTime] = useState<string | undefined>(undefined)
  ...
  const handleCreateBooking = async () => {
    try {
      if (!selectedDate || !data?.user?.id) return
                ...
                <SheetContent className="px-0">
                  ...
                  <div className="border-b border-solid py-4">
                    <Calendar
                      mode="single"
                      locale={ptBR}
                      className="w-full items-center justify-center rounded-lg capitalize"
                  ...
                  <SheetFooter className="mt-5 p-0 px-5">
                    <Button
